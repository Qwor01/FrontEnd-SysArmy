...
const Birras = () => {
  ...
  return (
    <div className='bg-neutral-900 h-screen'>
        <h1 className='flex text-white justify-center text-center text-5xl subpixel-antialiased font-bold p-8 sm:w-screen md:w-full'> {`Próximas AdminBirras: ${formatearEspañol(birrasDate)}`} </h1>
